...
const SignLayout = ({ children }: PropsWithChildren) => {
  return (
    <main className="relative flex justify-center items-center max-w-1440 min-h-screen mx-auto gap-16 bg-gray-10">
      <Link href="/">
        <Image className="absolute top-23 left-120" src={UtripLogo} width={78} height={39} alt="logo" />
      </Link>

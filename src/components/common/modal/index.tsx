...
const Modal = ({ isOpen, close, children, noClose, className }: ModalProps) => {
  const modalClass = twMerge(
    'flex flex-col fixed top-1/2 left-1/2 bg-white shadow-main rounded-l zIndex-modal transform -translate-x-1/2 -translate-y-1/2 px-28 py-32 w-540',
    className,
  );
